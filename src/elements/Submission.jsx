        ...
        <div className="form-container" style={{ textAlign: 'center', padding: '20px' }}>
            ...
            <div className="form-section" style={{ display: 'flex', justifyContent: 'center', gap: '20px', marginBottom: '20px' }}>
                ...
                <div className="upload-btn" style={{ textAlign: 'center' }}>
                    ...
                    <span>UPLOAD EVIDENCE<br />(jpeg/jpg, png)</span>
                </div>
            </div>
            <input type="text" placeholder="Title*" required style={{ width: '80%', padding: '10px', marginBottom: '10px' }} />
            <textarea rows="4" placeholder="Description" required style={{ width: '80%', padding: '10px', marginBottom: '10px' }}></textarea>
            <button className="submit-btn" style={{ padding: '10px 20px', cursor: 'pointer' }}>SUBMIT</button>
        </div>
    );
};
